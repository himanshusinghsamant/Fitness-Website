...
const Cart = () => {
  ...
  return (
    <div>
        <Navbar/>
      <h1 style={{color:'white', paddingTop:'100px',display:'flex' ,alignItems:'center', justifyContent:'center'}}>Your Cart Items</h1>

      <div className="Tot-amount" style={boxSty} >
        <h2 style={textCol}>SubTotal : Rs. {totalAmount} </h2>
        <div className="checkout">
          <button onClick={()=>Navigate('/shop')} style={btnStyle}>Continue Shopping</button>
